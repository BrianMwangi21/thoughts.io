...
export default function UserInput() {
  ...
  return (
    <animated.div style={slideInAnimation} className="z-1000 bg-white rounded-t-2xl absolute bottom-0 shadow-2xl h-30 w-9/12 md:w-4/12 flex items-center flex-col gap-4 p-6">
